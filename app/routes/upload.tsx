...
const Upload = () => {
    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}:{companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        ...
        if(!uploadedFile) return setStatusText("Error uploading file. Please try again.");
        ...
        if(!uploadedImage) return setStatusText("Error uploading image. Please try again.");
                ...
                <div className={"page-heading py-16"}>
                    <h1>Smart Feedback for your Dream Job</h1>
                    {
                        isProcessing ? (
                            ...
                            <h2>Drop in your resume for an ATS score and improvement tips</h2>
                        )
                    }
                    {
                        !isProcessing && (
